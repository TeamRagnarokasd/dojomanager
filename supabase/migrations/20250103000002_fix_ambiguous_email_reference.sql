-- CRITICAL FIX: Resolve the "column reference email is ambiguous" error
-- This migration completely replaces the problematic create_student_registration function
...
BEGIN
    ...
    -- Let the unique constraints handle duplicates naturally
    ...
    BEGIN
        INSERT INTO public.user_profiles (
            ...
            user_id, normalized_email, full_name, phone, birth_date, codice_fiscale,
            address_line, city, province, cap, emergency_contact,
    ...
    IF profile_created THEN
        BEGIN
            INSERT INTO public.pending_registrations (
                ...
                normalized_email, full_name, phone, 'student', 'pending',
...
-- Add comment to track this critical fix
...
IS 'CRITICAL FIX: Resolved ambiguous email column reference error. This function properly qualifies all column references and checks for existing users before registration.';
