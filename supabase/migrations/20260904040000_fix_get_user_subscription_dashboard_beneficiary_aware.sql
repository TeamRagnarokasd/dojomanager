-- ============================================================
-- Fix get_user_subscription_dashboard: beneficiary-aware filter
-- Replaces WHERE pc.user_id = user_uuid with a check on
-- beneficiary_profile_id (with fallback for legacy NULL rows).
