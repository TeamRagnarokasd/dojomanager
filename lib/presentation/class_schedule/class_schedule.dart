...
class _ClassScheduleState extends State<ClassSchedule>
  ...
  void _showBookingModal(ClassScheduleModel classData) async {
    ...
    // Guard: do not allow booking a class that has already started or ended
    try {
      final timeParts = classData.startTime.split(':');
      final classDate = DateTime.parse(classData.classDate);
      ...
      if (DateTime.now().isAfter(classDateTime)) {
        Fluttertoast.showToast(
          msg: 'Non è possibile prenotare una lezione già iniziata o conclusa.',
