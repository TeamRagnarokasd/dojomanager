  ...
  Widget _buildInstructorCard(Map<String, dynamic> instructor) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isActive ? const Color(0xFF333333) : Colors.grey[800]!,
        ),
      ),
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(16),
          onTap: () => widget.onInstructorSelected(instructor),
          child: Padding(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isActive ? const Color(0xFFFF0000) : Colors.grey,
                      width: 2,
                    ),
                  ),
                  child: ClipRRect(
                      ...
                      if (disciplines != null && disciplines.isNotEmpty)
                        Padding(
                          ...
                          child: Wrap(
                            ...
                            runSpacing: 4,
                            children:
                                disciplines.take(3).map((discipline) {
                                  return Container(
                                    padding: const EdgeInsets.symmetric(
                                      horizontal: 8,
                                      vertical: 2,
